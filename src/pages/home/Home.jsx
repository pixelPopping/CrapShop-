                ...
                <div>
                    <div className="button-container4">
                        ...
                        <button onClick={() => navigate("/favorietenpage")}>
                            Favorieten ({favoriteItems.length})
                        </button>
                    </div>
                </div>
            </nav>
            ...
            <main>
              ...
              <span className="font span1">
                ...
                <h5>Vintage</h5>
                            ...
                            <span className="font span6">
                <h5>10% korting</h5>
              </span>
                            <span className="font span7">
                <h5>extra spin</h5>
              </span>
                            <span className="font span8">
                <h5>15% korting</h5>
              </span>
                            <span className="font span9">
                <h5>gift</h5>
              </span>
                            <span className="font span10">
                <h5>30% korting</h5>
              </span>
                        </div>
                    </div>
